...
export function CommandPalette({ open, onClose, placeholder = "Type a command or search…", groups = [], className }) {
  ...
  return (
    <div className="cs-cmdk-scrim" onClick={onClose}>
      <div className={cx("cs-cmdk", className)} role="dialog" aria-modal="true" aria-label="Command palette" onClick={(e) => e.stopPropagation()}>
        <div className="cs-cmdk__search">
          ...
          <span className="cs-kbd">Esc</span>
        </div>
